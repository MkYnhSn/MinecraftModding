package com.bryancui.cbymod.world.feature.tree;
...
public class WorldGenUraniumTree extends WorldGenAbstractTree
{
	public static final  IBlockState LOG = ModBlocks.CBY_BLOCK.getDefaultState();
	public static final  IBlockState LEAF = ModBlocks.NUCLEAR_BOMB.getDefaultState();
	
	private int minHeight;

	public WorldGenUraniumTree() 
	{
		super(false);
		this.minHeight = 10;
	...
	{
		int height = this.minHeight + rand.nextInt();
		boolean flag = true;
		...
		else 
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (SaplingBase)ModBlocks.sapling);
