...
public class Thor extends ToolSword
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	{
		...
		EntityLightningBolt lightning = new EntityLightningBolt(worldIn, playerIn.posX, playerIn.posY, playerIn.posZ, false);
		
		
		worldIn.spawnEntity(lightning);
		lightning.setPosition(playerIn.posX+ aim.x*5, playerIn.posY + aim.y*5, playerIn.posZ + aim.z*5);
